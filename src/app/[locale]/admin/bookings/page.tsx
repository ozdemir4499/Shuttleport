                ...
                <tr key={b.id} className="hover:bg-indigo-50/40 transition-all duration-300 group relative">
                  ...
                  <td className="px-3 py-4 whitespace-nowrap">
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center gap-2">
                        <div className="w-[85px] shrink-0 text-lg font-black bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 flex items-baseline gap-1">
                          ...
                          <span className={`text-sm font-black drop-shadow-sm ${
                            b.currency === 'USD' ? 'text-emerald-500' :
                      ...
                      <div className="flex items-center gap-2">
                        <div className={`w-[85px] shrink-0 flex justify-center items-center gap-1 text-[9px] font-bold uppercase tracking-widest px-1 py-1 rounded border ${
                          b.vehicle_type === 'vip_vito' ? 'bg-fuchsia-50 text-fuchsia-600 border-fuchsia-100' :
