...
export default function TurlarClient({ initialTours }: { initialTours: any[] }) {
                            ...
                            <div className="lg:sticky lg:top-32">
                                ...
                                <div className="hidden md:block space-y-4 mb-8">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        <button className="px-4 py-2 bg-[#0a192f] text-white rounded-lg text-sm font-bold">{t('all')}</button>
                                        ...
                                        <button className="px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg text-sm font-bold hover:border-[#0a192f] hover:text-[#0a192f] transition-colors">{t('daily')}</button>
                                        <button className="px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg text-sm font-bold hover:border-[#0a192f] hover:text-[#0a192f] transition-colors">{t('culture')}</button>
                                        <button className="px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg text-sm font-bold hover:border-[#0a192f] hover:text-[#0a192f] transition-colors">{t('sea')}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
