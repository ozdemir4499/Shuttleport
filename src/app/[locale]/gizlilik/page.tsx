    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-16 text-slate-800">
            ...
            <div className="prose lg:prose-xl">
                ...
                <p>Sistemimizde kayıtlı olan tüm verilerinizin "Unutulma Hakkı" kapsamında silinmesini talep etmek için <strong>support@shuttleport.com</strong> adresine e-posta gönderebilirsiniz. Talebiniz 48 saat içinde işleme alınacaktır.</p>
            </div>
        </div>
    );
}
